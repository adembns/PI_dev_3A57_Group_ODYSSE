 ...
 */
final class Version20240220131009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blog_comment (id INT AUTO_INCREMENT NOT NULL, contenu VARCHAR(10000) NOT NULL, date_creation DATE NOT NULL, date_modify DATE DEFAULT NULL, users_id INT NOT NULL, blog_article_id INT DEFAULT NULL, INDEX IDX_7882EFEF67B3B43D (users_id), INDEX IDX_7882EFEF9452A475 (blog_article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
